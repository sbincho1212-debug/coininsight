...
- 필수 frontmatter:
  ...
  ---
  ```
- pubDate는 항상 현재 날짜인 2025-12-08을 사용 (사용자가 별도로 지정하지 않는 한)

### 자동화 워크플로우

사용자가 **"새 글 작성"**이라고 입력하면:
1. 최근 작성된 글 주제 확인 (중복 방지)
2. 새로운 주제 선정
3. 4,000자 이상의 고품질 콘텐츠 작성
4. Unsplash에서 적절한 이미지 검색 및 삽입
5. SEO 최적화된 frontmatter 작성
6. `src/content/blog/` 디렉토리에 `.md` 파일 저장
